...
def extract_volume_fields(bound_min, bound_max, resolution, query_func, S=128):
...
def extract_volume(bound_min, bound_max, resolution, query_func):
    ...
    volume = extract_volume_fields(bound_min, bound_max, resolution, query_func)
    ...
    # vertices = vertices / (np.array(resolution) - 1.0) * (b_max_np - b_min_np)[None, :] + b_min_np[None, :]
    return volume
